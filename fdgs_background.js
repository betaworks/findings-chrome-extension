chrome.browserAction.onClicked.addListener(function(tab) {
    ...
    injectBookmarklet += "e.setAttribute('src', 'http://dev.new.findings.com/extension/loader');";
...
(function(w) {
    ...
    w.App = {
        ...
        useDomain: "dev.new.findings.com",
        ...
        getFindingsLoginStatus: function(callback) {
            ...
            var userURL = "http://" + _this.useDomain + "/user/is_logged_in/";
            ...
            $.getJSON(userURL, function(user) {
                ...
                user.link = "<a href='http://" + _this.useDomain + "/" + user.username + "/' target='blank'>" + user.username + "</a>";
