chrome.browserAction.onClicked.addListener(function(tab) {
	...
	if(eval(localStorage['isDev'])) {
		...
		chrome.tabs.executeScript(null, {code: "FDGS_BASE_DOMAIN = '" + localStorage['devDomain'] + "'; FDGS_LOGGING_ENABLED = true; FDGS_DISABLE_CACHING = false;"});
	} else {
		chrome.tabs.executeScript(null, {code: "FDGS_BASE_DOMAIN = 'findings.com'; FDGS_LOGGING_ENABLED = false; FDGS_DISABLE_CACHING = true;"});
	}
